	...
	<script type="text/javascript">
		...
		function check_agree(){
			if($(".agreeCheck_01").is(":checked") == false){
				...
				return;
			//}else if($(".agreeCheck_03").is(":checked") == false){
...
<body>
	<div id="Wrapper">
			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					...
					<section class="section">
						<form id="agreeForm" action="http://www.bitacademy.com/Member/IPIN/Join_step2.asp">
							...
							<div class="btn_wrap c">
								<a title="동의" class="btnBlueBorder big" onClick="javascript:check_agree();" style="border-width:2px;">다음</a>
								<a href="javascript:history.back();" title="취소" class="btnWhiteBorder big" style="border-width:2px;">취소</a>
							</div>
						</form>
					</section>
		...
		<%
			'response.write("Session RefererURL : " & Session("RefererURL"))
			'response.write("<span style='font-size:4px;'>" & Date() & " // " & Time() & " // " & Session("RefererURL") & "</span>")
		%>			
		<%
		...
		<%
			...
			myDate = Date()
			myTime = Time()
			myURL = Session("RefererURL")
			sql = "INSERT INTO db_bit.dbo.ManagerReferer (DATE, TIME, URL, ARRIVED, Etc) VALUES ('"&myDate&"','"&myTime&"','"&myURL&"','회원가입','')"
