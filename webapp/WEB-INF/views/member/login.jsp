                                ...
                                <div class="loginBox_1704">
                                    ...
                                    <div class="btn_wrap">
                                        <a href="javascript:submit_it()" title="" class="loginBtn btn">
                                            로그인<img src="${pageContext.request.contextPath}/assets/Images/Common/ico_lockOpen_128_NearlyWhite.png" style="height:36px; margin-top:15px; margin-left:10px;"/>
                                        </a>
                                    </div>
                                    <div class="btn_wrap no2" style="width:353px; opacity:0.7;">
                                        <a href="${pageContext.request.contextPath}/member/Join_Step1" title="" class="joinBtn btn white">회원가입</a>
                                        <a href="${pageContext.request.contextPath}/member/id_pass_search_01" class="idpwBtn btn white">아이디/비밀번호 찾기</a>
                                    </div>
                                </div>
                            </div>
                            <div style="float:left; height:304px; overflow:hidden;">
                                ...
                                <div style="width:214px; box-shadow:1px 1px 5px #0f0f0f; ">
                                    <ul class="slider" style="min-height:264px; width:214px; ">
                                        <li><a href="${pageContext.request.contextPath}/course/license/Course_Licenses"><img src="${pageContext.request.contextPath}/assets/Images/Main/img_pop_BSPM1.png" style="width:214px; height:264px;"/></a></li>
                                        <li><a href="${pageContext.request.contextPath}/course/license/Course_Licenses"><img src="${pageContext.request.contextPath}/assets/Images/Main/img_pop_BSPM2.png" style="width:214px; height:264px;"/></a></li>
                                    </ul>
                                </div>
                            </div>
