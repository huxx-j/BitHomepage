								...
								<div class="divTable">
									<table>
										...
										<tbody>
											...
											-->
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="name">이름<span class="star">*</span></td>
												<td colspan="2">
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="username">아이디 <span class="star">*</span></td>
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="password">비밀번호<span class="star">*</span></td>
												<td colspan="2"><input type="password" name="password" id="joinInfo_03" class="w167">
												<span>대,소문자를 구분합니다.</span></td>
											</tr>
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="confirm_pwd">비밀번호 확인<span class="star">*</span></td>
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="telephone1">전화번호<span class="star">*</span></td>
												<td colspan="2">
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="handphone1">핸드폰번호<span class="star">*</span></td>
												<td colspan="2">
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="mail1">이메일<span class="star">*</span></td>
												<td colspan="2">
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="bitletter">메일수신<span class="star">*</span></td>
												<td colspan="2">
											...
											<tr>
												<td scope="row" class="darker c" scope="row" class="tit"><label for="joinInfo_10">직업<span class="star">*</span></td>
												<td colspan="2">
