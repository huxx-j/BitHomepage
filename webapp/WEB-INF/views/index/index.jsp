...
-->
	...
	<script>
		...
		var NUM_OF_WIDEBANNERS = 3;	// 와이드배너이미지 개수. 					// OVERRIDE
		var arrWidebannerAddr = new Array(
					"",
					"/Course/BITsupporters_2018.asp",
					"/Center/Center_info.asp"
					);																			// OVERRIDE
		var arrWidebannerBgColor = new Array( "#004986", "#2c2d2c", "#4c4c4c");					// OVERRIDE   "#1d3660", 
	...
	<div id="Wrapper">
		...
		<div style="width:100%; background-color:#4c4c4c; height:345px;">
			...
			<div id="mainWideBanner" style="width:960px; margin:0 auto;">
				...
				<img src="${pageContext.request.contextPath}/assets/Images/Banners/MainPage_Banner__SWETI.png" href="" style="position:absolute;"/>
				...
				<!--<img src="Images/Banners/MainPage_Banner__BITsupporters.jpg" href="" style="position:absolute; opacity:0.0; "/>
				<img src="Images/Banners/widebanner_Bitacademy.png" href="" style="position:absolute; opacity:0.0; "/>-->
				
	<!-- TODO : to put these circles programmably -->
	<!-- TODO : to reactivate mouseleave event handler -->
				<img class="navigatorWideBanner" src="${pageContext.request.contextPath}/assets/Images/Icons/icn_Navigator_Filled.png" style="position:relative; height:11px; left:850px; top:20px; z-index:10;"/>
				...
				<!--<img class="navigatorWideBanner" src="Images/Icons/icn_Navigator_NotFilled.png" style="position:relative; height:11px; left:870px; top:20px; z-index:10;"/>
				<img class="navigatorWideBanner" src="Images/Icons/icn_Navigator_NotFilled.png" style="position:relative; height:11px; left:880px; top:20px; z-index:10;"/>-->
			</div>
		</div>
...
-->					
				...
				<div id="Content">
					...
					<img src="${pageContext.request.contextPath}/assets/Images/Titles/MainPage_Title__무료취업과정.png" style="float:left; margin-bottom:2px;" alt="무료취업과정"/>
						...
						<div class="slot extended" style="background:url('${pageContext.request.contextPath}/assets/Images/Slots/2/MainPage_Slot__embedded.gif')" href="/course/expert/Course_Expert_Embedded">
							<img class="slotIcon" src="${pageContext.request.contextPath}/assets/Images/Icons/MainPage_SlotIcon__new.png"/>
							<p class="courseName dnone">&nbsp;</p>
							<p class="courseDescription dnone">&nbsp;</p>
							<div class="insideSlot" style="background:url('${pageContext.request.contextPath}/assets/Images/MainPage_SlotSelected_280px.png'); opacity:0;  -ms-filter:'progid:DXImageTransform.Microsoft.Alpha(Opacity=0)'"></div>
