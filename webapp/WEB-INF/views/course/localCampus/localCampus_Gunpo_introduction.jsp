...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no4 .newdepth3:eq(0)").addClass("on");		// 군포캠퍼스 소개 ON 
				...
				<div id="Content">
					...
					<section class="section">
						...
						<div class="con_wrap1709">
							<h5>군포캠퍼스 소개</h5>
							<p class="mar_b10">서울에 오셔서 교육을 받아야 하는 현실이 많이 불편하셨죠? 더 이상 소프트웨어 프로그래밍 교육을 받기 위해 서울까지 상경할 필요가 없습니다. 체계적인 교육시스템과 최고의 교육시설로 군포캠퍼스를 OPEN 했습니다.</p>
						</div>
						<!-- //con_wrap1709 -->
						...
						<div class="con_wrap1709">
							...
							<img src="${pageContext.request.contextPath}/assets/Images/roadmap_Gunpo.png"/>
						</div>
						<!-- //con_wrap1709 -->
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Date/Date__GP_C.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__GP_C.jsp"/>
												<!--2017.12.26(화) ~ 2018.01.11(목)-->
											</td>
											<th scope="row" class="tit">강의시간</th>
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__GP_C.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__GP_C.jsp"/>
												<!--09:00 ~ 15:00 (5시간)-->
											</td>
											<!--
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__GP_DS.jsp"/>
												<!--2018.01.30(화) ~ 2018.02.14(수)-->
											</td>
											<th scope="row" class="tit">강의시간</th>
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__GP_DS.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__GP_DS.jsp"/>
												<!--09:00 ~ 15:00 (5시간)-->
											</td>
											<!--
											<th scope="row" class="tit">저녁반</th>
						...
						<div class="con_wrap1709">
							...
							<div class="con_wrap1709">
								<h5>오시는 길</h5>
								<img src="${pageContext.request.contextPath}/assets/Images/location_Gunpo.png" style="width:640px;"/>
							</div>
							<!-- //con_wrap1709 -->
