		...
		<div id="Container">
			<div id="Content" class="sub">
				...
				<section class="section mar_t40">
					...
					<div class="form_type1 bor_solid_top10_green">
						<table border="1" class="table_col_type1">
							<caption>군포캠퍼스 JAVA 고급과정 일정</caption>
							<colgroup>
								<col style="width:15%">
								<col style="width:35%">
								<col style="width:15%">
							...
							<tbody>
								<tr>
									...
									<td colspan="3" class="l">JAVA 고급과정</td>
								</tr>
								<tr>
									<th scope="row">강의일정</th>
									<td class="l">2014.11.03 ~ 2015.02.28 (4개월)</td>
									<th scope="row">강의시간</th>
									<td class="l">09:00 ~ 16:00 (6시간)</td>
								</tr>
								<tr>
									<th scope="row">교육비</th>
									<td class="l">2,700,000원</td>
				...
				<section class="section infoCon">
					<dl>
						<dt>교육소개</dt>
						<dd>본 과정은 JAVA를 중심으로 객체지향 기법과 설계, 분석능력을 함양하고 데이터베이스, 각 서버와의 연동, Servlet/JSP, MVC, Struts, Spring등 JAVA 기술들을 활용하여 다양한 형태의 응용 프로그램과 비즈니스 솔루션을 구축할 수 있는 능력을 배양함.</dd>
					</dl>
					<dl>
						<dt>교육목표</dt>
						<dd>
							<ul class="ul_hyphen_gray">
								<li>프자바언어를 배워 객체지향 언어의 필요성과 객체지향 프로그래밍에 대한 지식을 습득할 수 있다.</li>
					...
					<dl class="bg_none">
						...
						<dd>
							<div class="form_type1 bor_solid_top10_green">
								<table border="1" class="table_col_type1">
									<caption>군포캠퍼스 JAVA 고급과정 교육내용</caption>
									<colgroup>
										<col style="width:35%">
										<col style="width:65%">
									</colgroup>
