	...
	<div id="Wrapper">
		...
		<div class="banner_wrap">
			<div class="banner pd_t50">
				<h3><span class="courseName">대전캠퍼스 - 자료구조/알고리즘</span></h3>
		...
		<div id="Container_Wrap">
			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					<div class="hGroup">
						<h4>자료구조/알고리즘<a href="/Register/Request/register_localCampus.asp" class="btn mid green1 mar_l10">지원하기</a></h4>
						<p class="lineMap">
							<a href="#this">홈</a>
							<a href="#this">과정안내</a>
							<a href="#this">대학비트</a>
						...
						<div class="con_wrap">
							<div class="form_type1 mar_b20">
								<table class="table_col_type1">
									<caption>대전캠퍼스 자료구조/알고리즘</caption>
									<colgroup>
										<col style="width:10%">
										<col style="width:35%">
										<col style="width:10%">
									...
									<tbody>
										<tr>
											...
											<td colspan="4">자료구조/알고리즘</td>
										</tr>
										<tr>
											<th scope="row" class="tit">강의일정</th>
											<td>
												<ul>
													<li>2015.08.03 ~ 2015.08.21</li>
												</ul>
											</td>
