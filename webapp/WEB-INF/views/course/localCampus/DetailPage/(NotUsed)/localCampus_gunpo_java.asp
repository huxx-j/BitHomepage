...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb .depth2_wrap.no7").find("li a").eq(2).addClass("on");
		});
	</script>
	...
	<div id="Wrapper">
		...
		<div class="banner_wrap">
			<div class="banner pd_t50">
				<h3><span class="courseName">군포캠퍼스 - Java Programming</span></h3>
		...
		<div id="Container_Wrap">
			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					<div class="hGroup">
						<h4>Java Programming<a href="/Register/Request/register_localCampus.asp" class="btn mid green1 mar_l10">지원하기</a></h4>
						<p class="lineMap">
							<a href="#this">홈</a>
							<a href="#this">과정안내</a>
							<a href="#this">대학비트</a>
							<a href="#this">군포캠퍼스</a>
							<a href="#this" class="last on">Java Programming</a>
						</p>
					</div>
					<section class="section">
						...
						<div class="con_wrap">
							<div class="form_type1 mar_b20">
								<table class="table_col_type1">
									<caption>군포캠퍼스 Java Programming</caption>
									<colgroup>
										<col style="width:10%">
										<col style="width:35%">
										<col style="width:10%">
						...
						<div class="con_wrap">
							...
							<table class="table_col_type2">
								<caption>군포캠퍼스 Java Programming 커리큘럼</caption>
								<colgroup>
									<col style="width:30%">
									<col style="width:30%">
									<col style="width:40%">
