...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no4 .newdepth3:eq(1)").addClass("on");		// C 프로그래밍 ON 
		});
	</script>
						...
						<div class="con_wrap1709">
							<div class="divTable">
								<table>
									...
									<tbody>
										<!-- (DEPRECATED) # i n c lude virtual="/Include/CourseDateTime/LocalCampus_Gunpo_C_DetailPageTR.inc" -->
										<tr>
