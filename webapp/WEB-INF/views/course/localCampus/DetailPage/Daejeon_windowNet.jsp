				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							...
							<img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>[대전]대전비트캠퍼스
						</p>
						<h4>
							Windows .NET 고급과정
							<a href="/course/LocalCampus/LocalCampus_Daejeon_Introduction?beginwith=booklet" title="프로젝트 살펴보기" class="btnRedBorder" style="font-size:15px; padding:0 5px; margin-left:10px; border-radius:0px; letter-spacing:-1.5px;">프로젝트 살펴보기</a>
							<a href="/course/LocalCampus/LocalCampus_Daejeon_Introduction?beginwith=entryWorks" title="공모전 출품작" class="btnRedBorder" style="font-size:15px; padding:0 5px; margin-left:10px; border-radius:0px; letter-spacing:-1.5px;">공모전 출품작</a>
						</h4>
					</div>
					...
					<section class="section">
							...
							<div class="divTable">
								<table>
									...
									<tbody>
										...
										<%-- <c:import url="/WEB-INF/views/Include/CourseDateTime/LocalCampus_Daejeon_WinHigh_DetailPageTR.jsp"/> --%>
										<tr>
						...
						<div class="con_wrap1709">
							<h5>교육장소</h5>
							<ul class="ul_dot_gray">
								<li>대전광역시 동구 자양동 52-2 우송IT교육센터 3층
									<img style="margin-top:-68px; height:100px;" src="${pageContext.request.contextPath}/assets/Images/img_qrcode_daejeon.jpg"/>
								</li>
							</ul>
						</div>
						<!-- //con_wrap1709 -->
