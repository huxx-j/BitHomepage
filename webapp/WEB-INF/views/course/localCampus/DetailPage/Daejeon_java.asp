...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no2 .newdepth3:eq(3)").addClass("on");		// Java 프로그래밍 ON 
		});
	</script>
				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							...
							<img src="/Images/Icons/icn_ArrowTriangleRight.png"/>[대전]대전캠퍼스
						</p>
						<h4>JAVA 프로그래밍</h4>
					</div>
						...
						<div class="con_wrap1709">
							<div class="divTable">
								<table>
									...
									<tbody>
										<!-- # i n c lude virtual="/Include/CourseDateTime/LocalCampus_Daejeon_Java_DetailPageTR.inc" -->
										<tr>
