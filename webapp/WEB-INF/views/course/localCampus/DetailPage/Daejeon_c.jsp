...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no2 .newdepth3:eq(1)").addClass("on");		// C 프로그래밍 ON 
		});
	</script>
							...
							<div class="divTable">
								<table>
									...
									<tbody>
										...
										<%-- <c:import url="/WEB-INF/views/Include/CourseDateTime/LocalCampus_Daejeon_C_DetailPageTR.jsp"/> --%>
										<tr>
