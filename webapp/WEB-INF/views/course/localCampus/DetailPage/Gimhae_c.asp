...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no5 .newdepth3:eq(1)").addClass("on");		// C 프로그래밍 ON 
		});
	</script>
				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							...
							<img src="/Images/Icons/icn_ArrowTriangleRight.png"/>[김해]김해캠퍼스
						</p>
						<h4>C 프로그래밍</h4>
					</div>
					<section class="section">
						...
						<div class="con_wrap1709">
							<h5>교육장소</h5>
							<ul class="ul_dot_gray">
								<li>김해 비트교육센터<img style="margin-top:-68px; height:100px;" src="img_qrcode_Gimhae.jpg"/></li>
							</ul>
						</div>
						<!-- //con_wrap1709 -->
						...
						<div class="con_wrap1709">
							...
							<div class="divTable">
								<table>
									<caption>김해캠퍼스 C Programming 커리큘럼</caption>
									<colgroup>
										<col style="width:25%">
										<col style="width:25%">
										<col style="width:50%">
