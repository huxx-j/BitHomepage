...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3_wrap.no3 .newdepth3:eq(3)").addClass("on");		// 자료구조/알고리즘 ON 
		});
	</script>
				...
				<div id="Content">
					...
					<section class="section">
						...
						<div class="con_wrap1709">
							<div class="divTable">
								<table>
									...
									<tbody>
										<!-- # i n c lude virtual="/Include/CourseDateTime/LocalCampus_Busan_DS_DetailPageTR.inc" -->
										<tr>
						...
						<div class="con_wrap1709">
							...
							<div class="divTable">
								<table>
									<caption>부산캠퍼스 자료구조 커리큘럼</caption>
									<colgroup>
										<col style="width:20%">
										<col style="width:20%">
										<col style="width:60%">
