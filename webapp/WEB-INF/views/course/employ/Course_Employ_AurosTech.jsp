...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".snb_1709 .newdepth2_wrap.no3").find("li a").eq( getIndex("AurosTech") ).addClass("on");
        });
    </script>
            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>㈜오로스테크놀로지
                    </p>
                    <h4 style="float:left;">㈜오로스테크놀로지 신입사원채용교육</h4>
                    <!-- 수강신청btn -->
                ...
                <section class="section" style="margin-top:5px;">
                    <div class="con_wrap1709 first">
                        <!--<h5>지원시 유의사항</h5>-->
                        <p>신입사원채용프로그램은 ㈜오로스테크놀로지의 인재상, 조직문화, 업무특성에 맞는 인재를 비트교육센터와 공동으로 선발하여 정직원으로 채용 후 사내교육의 일환으로 기업은 비트교육센터의 강도높은 전문가과정에 신입사원연수를 위탁, 실시하는 프로그램입니다. 교육 전 정직원으로 채용이 확정되므로 신입사원의 교육비 전액은 기업에서 지원합니다. 지금까지 비트교육센터의 신입사원채용프로그램을 통해 1,000여명(2018년 기준) 이상의 인재가 SW전문개발자로써 채용되었습니다.</p>
                    </div>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary1_AurosTech.jsp"/>
                        <!--
                        <p class="mar_t20 mar_b20"><img src="/Images/Content/Employ/img_LOGO_AurosTech.png" style="width:150px;"></p>
                        <p>
                            (주)오로스테크놀로지는 국가대표 기업이라는 자부심으로 국내 유일의 반도체 전공정용 계측/검사 장비를 국산화 성공시킨 전문업체입니다.<br/>
                            50명의 연구원들로 부설연구소를 운영하고 있으며, 여러 정부과제를 우수한 성적으로 수행 중입니다.<br/>
                            사업분야: Overlay, SEM, Inspection, Display
                        </p>
                        <a href="http://www.aurostech.com/" class="blueTxt fb" target="_blank">홈페이지 주소 : http://www.aurostech.com/</a>
                        -->
                    </div>

                    <div class="con_wrap1709">
                        <h5>복지사항</h5>
                        <p>단체상해보험, 직장어린이집, 체력단련실 운영, 중식/석식 및 커피 제공, 워크샵<br/>기숙사운영, 리조트/콘도, 동호회 등</p>
                    </div>

                    <div class="con_wrap1709">
                        <h5>채용 분야 및 응시자격</h5>
                        <!-- #include virtual="/Course/Employ/Summary2_AurosTech.asp"-->
                        <c:import url="/WEB-INF/views/course/employ/Summary2_AurosTech.jsp"/>
                        <!--
                        <div class="divTable">
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        <td class="c">반도체 Overlay 장비 SW <br/>개발 업무</td>
                                        <td class="c">2 명</td>
                                        <td rowspan="2">
                    ...
                    <div class="con_wrap1709">
                        ...
                        <ul>
                            ...
                            <li>수강안내 → 신규지원 → 신입사원채용교육 → ㈜오로스테크놀로지 지원(1,2지망 모두)</li>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <ul class="ul_dot_gray">
                            ...
                            <li>2차 전형 : 면접(㈜오로스테크놀로지 임원진) - 1차 합격자에 한해 알림</li>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <ul class="ul_dot_gray">
                            <li>교육과정 : Windows .NET 고급과정 (6개월, 이론 3개월+프로젝트 3개월)
                                <%--<%--%>
                                    <%--'Windows .NET Expert - ㈜오로스테크놀로지 기업위탁과정--%>
                                <%--%>--%>
                            </li>
                            <!--<li>2015년 11월 ~ 2016년 4월(6개월과정)</li>-->
                            <li>교 육 비 : 무료 (570만원 / ㈜오로스테크놀로지 전액지원)</li>
                        </ul>
                    </div>
                    ...
                    <div class="btn_wrap c">
                        <a href="/Register/Request/register_employment1.asp" class="btn mid green1" title="㈜오로스테크놀로지 지원하기">지원하기</a>
                    </div>
                    -->
                </section>
            </div>
