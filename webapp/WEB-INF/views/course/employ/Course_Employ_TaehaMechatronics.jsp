            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>㈜태하메카트로닉스
                    </p>
                ...
                <section class="section" style="margin-top:5px;">
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary1_TaehaMechatronics.jsp"/>
                        <!--
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary2_TaehaMechatronics.jsp"/>
                        <!--
                        <div class="divTable">
                            <table>
                    ...
                    <div class="con_wrap1709">
                        <h5>전형 방법 및 일정</h5>
                        <p class="redTxt fb">전형 : <!-- #include virtual="/Course/Employ/Common_DateTime2.asp"--><c:import url="/WEB-INF/views/course/employ/Common_DateTime2.jsp"/><!--2016년 9월 26일(월) 오전 10시--> - 필기시험(C)</p>
                        <ul class="ul_dot_gray">
