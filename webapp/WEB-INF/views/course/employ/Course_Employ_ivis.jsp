...
<head>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".snb_1709 .newdepth2_wrap.no3").find("li a").eq( getIndex("IVIS") ).addClass("on");
        });
    </script>
    ...
    //alert( uAgent );
            for (var i = 0; i < mobilePhones.length; i++)
                if (uAgent.indexOf(mobilePhones[i]) > -1)
                   document.location = "http://www.bitacademy.com/Course/Employ/M/Course_Employ_IVIS.asp";
        */
    </script>
            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>㈜아이비스
                    </p>
                    <h4 style="float:left;">㈜아이비스 신입사원채용교육</h4>
                    <!-- 수강신청btn -->
                ...
                <section class="section" style="margin-top:5px;">
                    <div class="con_wrap1709 first">
                        <!--<h5>지원시 유의사항</h5>-->
                        <!--<p>㈜아이비스 신입사원채용교육은 인재상, 조직문화, 업무특성에 맞는 인재를 인턴형태로 선발하여 조기 양성 한다는 취지로 IT전문 교육기관인 비트교육센터의 강도 높은 교육과정을 전형절차에 포함시켰습니다. 이론과 실습을 포함한 6개월 동안의 본 과정을 정상적으로 이수 후 ㈜아이비스의 직원으로 정식채용이 확정됩니다.<br> (단, 교육비용은 회사가 전액 부담합니다.) </p>-->
                        <p>신입사원채용프로그램은 ㈜아이비스의 인재상, 조직문화, 업무특성에 맞는 인재를 비트교육센터과 공동으로 선발하여 정직원으로 채용 후 사내교육의 일환으로 기업은 비트교육센터의 강도높은 전문가과정에 신입사원연수를 위탁, 실시하는 프로그램입니다. 교육 전 정직원으로 채용이 확정되므로 신입사원의 교육비 전액은 기업에서 지원합니다. 지금까지 비트교육센터의 신입사원채용프로그램을 통해 1,000여명(2018년 기준) 이상의 인재가 SW전문개발자로써 채용되었습니다.</p>
                    </div>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary1_IVIS.jsp"/>
                        <!--
                        <p class="mar_t20 mar_b20">
                            <img src="/Images/Content/company_logo/img_LOGO_IVIS.png" style="width:300px;"/>
                        </p>
                        <p>㈜아이비스는 차량용 인포테인먼트 소프트웨어 솔루션 제공 업체로써 차세대 차량용 멀티미디어 소프트웨어 개발 및 컨설팅 전문회사 입니다. 자동차 업계의 관심이 정보통신기술을 접목한 지능형 시스템과 커넥티드 시스템으로 집중되고 있는 가운데, 다양한 기기연동 안전을 위한 자동 제어기능, 편의성을 위한 복합기능이 많아짐에 따라 소프트웨어의 복잡도가 높아지고 있습니다. 당사는 표준화된 차량용 소프트웨어 프레임워크에 대한 수요 증가에 대응하여 오픈 플랫폼 기반의 인포테인먼트 소프트웨어 프레임워크를 설계, 개발하고 이와 함께 ADAS, 차세대 HMI, CAN, 차량 이더넷 등의 솔루션 기술 개발에 집중하여 고품질, 고신뢰성을 기반으로 국내 자동차 소프트웨어의 수준을 높이고 경쟁력을 확보하는데 기여하고자 사업을 추진중입니다. </p>
                        <a href="http://www.ivisolution.com/" class="blueTxt fb" target="_blank">홈페이지 주소 : http://www.ivisolution.com/</a>
                        -->
                    </div>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary2_IVIS.jsp"/>
                        <!--
                        <div class="divTable">
                            <table>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <ul>
                            ...
                            <li>수강안내 → 신규지원 → 신입사원채용교육 → 아이비스 지원</li>
                    ...
                    <div class="con_wrap1709">
                        <h5>전형 방법 및 일정</h5>
                        <p class="redTxt fb">전형 : <!-- #include virtual="/Course/Employ/Common_DateTime2.asp"--><c:import url="/WEB-INF/views/course/employ/Common_DateTime2.jsp"/><!--2018년 2월 6일(화) 오전 10시--> - 필기시험(C)</p>
                        <ul class="ul_dot_gray">
                            <li>1차 전형 : 필기시험(C 프로그래밍)</li>
                            <li>2차 전형 : 면접(아이비스 임원진) - 1차 합격자에 한해 알림</li>
                    ...
                    <div class="btn_wrap c">
                        <a href="/Register/Request/register_employment1.asp" class="btn mid green1" title="아이비스 지원하기">지원하기</a>
                    </div>
                    -->
                </section>
            </div>
