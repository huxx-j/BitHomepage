            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>㈜비즈테크파트너스
                    </p>
                ...
                <section class="section">
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary1_BizTechPartners.jsp"/>
                        <!--
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary2_BizTechPartners.jsp"/>
                        <!--
                        <div class="divTable">
                            <table>
                    ...
                    <div class="con_wrap1709">
                        <h5>전형 절차</h5>
                            ...
                            <%--<p class="redTxt fb">전형 : <!-- #include virtual="/Course/Employ/Common_DateTime2.asp"--><c:import url="/WEB-INF/views/course/employ/Common_DateTime2.jsp"/><!--2016년 9월 26일(월) 오전 10시--> - 필기시험(JAVA) 및 면접</p>--%>

                        <ul>
                            <li>
                                1차 전형 : 필기시험 (Java Programming)<br/>
                                ※ 전형 장소 : 비트교육센터 비타임 (지하1층)<br/>
                                <span class="redTxt fb">※ 전형 일정 :  <c:import url="/WEB-INF/views/course/employ/Common_DateTime2.jsp"/><!-- #include virtual="/Course/Employ/Common_DateTime2.asp"--></span><br/>
