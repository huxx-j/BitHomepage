            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>㈜비트컴퓨터
                    </p>
                ...
                <section class="section" style="margin-top:5px;">
                    ...
                    <div class="con_wrap1709">
                        ...
                        <c:import url="/WEB-INF/views/course/employ/Summary1_BitComputer.jsp"/>
                    </div>

                    <div class="con_wrap1709">
                        <h5>모집요강</h5>
                        <!-- #include virtual="/Course/Employ/Summary2_BitComputer.asp"-->
                        <c:import url="/WEB-INF/views/course/employ/Summary2_BitComputer.jsp"/>
                        <!--
                        <div class="divTable">
                            <table>
                    ...
                    <div class="con_wrap1709">
                        ...
                        <ul>
                            <li>
                                ...
                                ※ 전형 장소 : 비트교육센터<br/>
                                <span class="redTxt"><b>※ 전형 일정 :  <!--2018년 4월 26일(목) 오후 1시--><!--#include virtual="/Course/Employ/Common_DateTime2.asp"--><c:import url="/WEB-INF/views/course/employ/Common_DateTime2.jsp"/></b></span><br/>
