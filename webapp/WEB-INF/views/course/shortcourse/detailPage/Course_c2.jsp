...
<head>
	...
	<script src="../../../../../../../../Desktop/shortcourse/detailpage/Common_getIndex.js"></script>
				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							...
							<img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>자료구조/알고리즘
					...
					<section class="section">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__cds2_core.jsp"/>
											<th scope="row" class="tit">강의시간</th>
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__cds2_core.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__cds2_core.jsp"/>
											</td>
										</tr>
										<tr>
						...
						<div class="con_wrap1709">
							<h5>과정 로드맵</h5>
							<div>
								<img src="${pageContext.request.contextPath}/assets/Images/img_Roadmap_C2.png" style="width:100%;"/>
							</div>
						</div>
						<!-- //로드맵 -->
