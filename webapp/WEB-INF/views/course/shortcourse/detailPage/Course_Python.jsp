					...
					<section class="section">
						...
						<div class="con_wrap1709 first">
							<div class="divTable">
								<table>
									...
									<tbody>
										<tr>
											...
											<td class="long">
												<!-- #include virtual="/Include/CourseDateTime/Date/Date__python.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__Python.jsp"/>
												<!--
											...
											<td class="long">
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__python.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__Python.jsp"/>
												<!--
								...
								<a href="/register/request/register_form?cID=<%=CourseID%>" title="수강신청" style="float:right; margin:12px 0;" class="btnApply">
