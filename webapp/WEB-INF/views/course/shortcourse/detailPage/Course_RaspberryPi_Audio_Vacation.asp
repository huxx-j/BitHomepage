...
<%
	dim CourseDateTime
	CourseDateTime = "2018.1.8 ~ 2018.1.12 <span class='greenTxt'>(오전반)</span><br/>" &_
						"2018.1.29 ~ 2018.2.2 <span class='greenTxt'>(오후반)</span><br/>" &_
					...
					<section class="section">
						...
						<div class="con_wrap1709 first">
							<div class="divTable">
								...
								<!-- 수강신청btn -->
								<!--
								<a href="/Register/Request/register_shortCourse.asp?cID=RaspberryPi_AudioVac" title="수강신청" style="float:right; margin:12px 0;" class="btnApply">
								-->
								<a href="javascript:alert('준비중입니다. 문의는 02-3486-3456 으로 전화주세요.');" title="수강신청" style="float:right; margin:12px 0;" class="btnApply">
