...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			//$(".snb_1709 a.newdepth1").eq(5).addClass("on");								// 방학특강 - 안드로이드 앱 개발
								...
								<table>
									...
									<tbody>
										<tr>
											...
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Date/Date__Android1_core.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__Android1_core.jsp"/>
												<!--
												2018.1.15~ 2018.1.25 <span class='greenTxt'>(오전반)</span><br/>
												2018.2.5~ 2018.2.19 <span class='greenTxt'>(오후반)</span><br/>
												2017.12.18~ 2018.1.4 <span class='greenTxt'>(저녁반)</span>
												-->
											</td>
											<th scope="row" class="tit">강의시간</th>
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__Android1_core.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__Android1_core.jsp"/>
												<!--
												오전반 9:00 ~ 13:00 (4시간/9일/총36시간)<br/>
												오후반 14:00 ~ 18:00 (4시간/9일/총36시간)<br/>
												저녁반 19:00 ~ 22:00 (3시간/12일/총36시간)
												-->
											</td>
										</tr>
										<tr>
