...
<%!
String CourseID = "db_modeling_core";
String SubjectName = "데이터베이스 모델링";
%>
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__db_modeling_core.jsp"/>
											</td>
											<th scope="row" class="tit">강의시간</th>
											<!--<td>주4일(월,화,수,목) 2주간<br/>19:00 ~ 22:00 (1일 3시간)</td>-->
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__db_modeling_core.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__db_modeling_core.jsp"/>
												<!--19:00 ~ 22:00 (1일 3시간)-->
											</td>
										</tr>
										<tr>
