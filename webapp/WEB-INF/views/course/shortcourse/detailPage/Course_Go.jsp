...
<link rel= "shortcut icon" href="${pageContext.request.contextPath}/assets/Images/favicon.ico">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth3.no7").addClass("on"); 								// Go 프로그래밍 - OPEN
		});
	</script>
					...
					<section class="section">
						...
						<div class="con_wrap1709 first">
							<div class="divTable">
								<table>
									...
									<tbody>
										<tr>
											<th>교육기간</th>
											<td>
											<!-- #include virtual="/Include/CourseDateTime/Date/Date__Go.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__Go.jsp"/>
											</td>
											<th>강의시간</th>
											<td>
											<!-- #include virtual="/Include/CourseDateTime/Time/Time__Go.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__Go.jsp"/>
											</td>
										</tr>
										<tr>
											<th>교육비용</th>
								...
								<a href="/register/request/register_form?cID=<%=strCourseID%>" title="수강신청" style="float:right; margin:12px 0;" class="btnApply">
						...
						<div style="clear:both;"></div>
							...
							<img src="${pageContext.request.contextPath}/assets/Images/DetailPage_Go.png" class="mar_l10"/> <!-- style="width:720px;"/>-->
