	...
	<div id="Wrapper">
		...
		<div class="banner_wrap">
			<div class="banner pd_t50">
				<h3><span class="courseName">여름특강 - JAVA Programming</span></h3>
						...
						<div class="con_wrap first">
							<div class="form_type1 mar_b20">
								<table class="table_col_type1">
									<caption>여름특강 - JAVA Programming</caption>
									<colgroup>
										<col style="width:10%">
										<col style="width:40%">
										<col style="width:10%">
									...
									<tbody>
										<tr>
											...
											<td colspan="3">여름특강 - JAVA Programming</td>
										</tr>
										<tr>
											...
											3차 : 2015.08.04 ~ 2015.08.24 (15일 / 총 60시간)
											</td>
											<th scope="row" class="tit">강의시간</th>
											<td>
											 1차/2차/3차 공통 <br>
											 오전반 : 09:00 ~ 13:00 (1일 4시간 / 월 ~ 금)<br>
											 오후반 : 14:00 ~ 18:00 (1일 4시간 / 월 ~ 금)<br>
