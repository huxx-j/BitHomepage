			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					...
					<section class="section">
								...
								<table class="table_col_type1">
									...
									<tbody>
										...
										<tr>
											...
											<td>
												<ul>
													<li>2017.03.06 ~ 2017.03.31 <span class="greenTxt">(저녁반)</span></li>
										...
										<tr>
											...
											<td>
												600,000원<!--394,440원--> <span class="blueTxt">(재직자 환급은 저녁반만 해당)</span><br/>
						...
						<!--#include file="Common_roadmap_C.inc"-->
						...
						<div class="con_wrap">
							<div style="float:left; width:180px;">
								<h5>교재 제공</h5>
								<img src="/Images/Content/img_BookCover_PassionOfC.jpg" style="margin-left:15px; width:160px;"/>
							</div>
						...
						<div class="con_wrap last">
							...
							<div class="tap_header">
								<ul class="tapMenu">
									<li class="on"><a href="#this" title="방학특강" onClick="javascript:ajaxLoad('#ConDetail', '', '/Course/ShortCourse/DetailPage/Course_c_curriculum1.asp')">방학특강</a></li>
