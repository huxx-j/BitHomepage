				...
				<div id="Content">
					<div class="hGroup1709">
						<p>
							...
							<img src="/Images/Icons/icn_ArrowTriangleRight.png"/>Blockchain
						</p>
						<h4><%=strSubject%></h4>
					</div>
							...
							<div class="divTable">
								<table>
									...
									<tbody>
										<tr>
											<th>교육기간</th>
											<td><!-- #include virtual="/Include/CourseDateTime/Date/Date__Bchain_HyperConnected.inc" --></td>
											<th>강의시간</th>
											<td><!-- #include virtual="/Include/CourseDateTime/Time/Time__Bchain_HyperConnected.inc" --></td>
										</tr>
										<tr>
											<th>교육비용</th>
											<td>1,500,000원</td>
...
<img src="Images/DetailPage_Course_Blockchain_HyperConnected_2.png" class="mar_l10"/> <!-- style="width:720px;"/>-->
