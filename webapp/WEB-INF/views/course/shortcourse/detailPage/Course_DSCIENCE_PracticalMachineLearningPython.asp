...
<%
dim strDate
strDate="2017.12.12 ~ 2017.12.21 (화,목)"

'// 과정명 변경 (2018-03-08) 실용 머신러닝 
strSubject = "Python을 활용한 실용머신러닝 - 초급"
...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth2_wrap.no2 .newdepth2").eq(2).addClass("on");  	// Python을 활용한 실용머신러닝-초급 ON
		});
	</script>
