				...
				<div id="Content">
					...
					<section class="section">
						...
						<div class="con_wrap1709" style="z-index:1;"> <!-- otherwise, 환급내용 자세히보기 div와 z-index problem happens -->
							...
							<div id="" style="float:left; margin-top:30px; margin-left:7px;"><a href="http://www.bitacademy.com/Course/License/Course_Licenses.asp" class="btnBlueBorder">자세히보기</a></div>
