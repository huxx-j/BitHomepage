...
<html lang="ko">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			/* page load 직후 SNB 셋팅 */
			$(".snb_1709 a.newdepth1").eq(2).addClass("on");								// Blockchain
			$(".snb_1709 .newdepth2_wrap").eq(2).addClass("on");						// Blockchain SUB - OPEN
			$(".snb_1709 .newdepth2_wrap.no3 .newdepth2").eq(0).addClass("on");  	// 블록체인 - 초연결 기술과 규제 ON
		});
	</script>
				...
				<div id="Content">
					...
					<section class="section">
								...
								<table>
									...
									<tbody>
										<tr>
											<th>교육기간</th>
											<td>
											<!-- #include virtual="/Include/CourseDateTime/Date/Date__Bchain_HyperConnected.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__Bchain_HyperConnected.jsp"/>
											</td>
											<th>강의시간</th>
											<td>
											<!-- #include virtual="/Include/CourseDateTime/Time/Time__Bchain_HyperConnected.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__Bchain_HyperConnected.jsp"/>
											</td>
										</tr>
										<tr>
											<th>교육비용</th>
						...
						<div style="clear:both;"></div>
							...
							<img src="${pageContext.request.contextPath}/assets/Images/DetailPage_Course_Blockchain_HyperConnected_2.png" class="mar_l10"/> <!-- style="width:720px;"/>-->
