...
<%!
String CourseID = "JP_core";
String SubjectName = "JAVA 설계과정";
%>
					...
					<section class="section">
						...
						<div class="con_wrap1709">
							...
							<ul class="ul_dot_gray">
								...
								-->
								<li>UML 실전에서는 이것만 쓴다<a href="/course/shortcourse/detailPage/Course_realUml" class="mar_l10 btnBlueBorder small">자세히보기</a></li>
							</ul>
						</div>
						<!-- //con_wrap1709 -->
						<!-- con_wrap1709 -->
