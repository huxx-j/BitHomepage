...
<%!
String CourseID = "Nodejs";
String SubjectName = "객체지향 JavaScript와 Node.js 프로그래밍";
%>
			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					...
					<section class="section">
						...
						<div class="con_wrap1709">
							<h5>선수 과목</h5>
							<p>JavaScript 프로그래밍<a href='/course/shortcourse/detailPage/Course_JavaScript' class='mar_l10 btnBlueBorder small' target="_blank">자세히 보기</a></p>
						</div>
						<!-- //con_wrap1709 -->
