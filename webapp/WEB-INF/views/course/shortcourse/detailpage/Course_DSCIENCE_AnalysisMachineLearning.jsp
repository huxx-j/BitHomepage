					...
					<section class="section">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__DSci_AnalysisMLearn1.jsp"/>
												<!--
											...
											<td class="spacing-2px">
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__DSci_AnalysisMLearn1.jsp"/>
												<!--
						...
						<div class="con_wrap1709">
							...
							<p>
								...
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig_01.png" style="width:100%;"/><br/>
								<b>+"dplyr 패키지 함수를 사용해서 데이터를 가공하고 요약하는 방법을 알려주세요."</b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig_02.png" style="width:100%;"/><br/>
								<b>+"투자가인데 R의 군집분석을 적용해서 투자 종목을 두개의 포트폴리오로 클러스터링해서 관리하고 싶습니다.”</b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig_3a.png" style="width:100%;"/><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig_3b.png" style="width:50%; margin-left:150px;"/><br/>
								<b>+"통계 초짜인데요, 데이터의 탐색적 분석을 위해서 통계와 시각화를 적용하고 싶습니다.” </b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig_4.png" style="width:50%; margin-left:150px;"/><br/>
							</p>
						</div>
						<!-- //con_wrap1709 -->
