	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			*/
			...
			$(".snb_1709 .newdepth4_wrap.no3 li:eq(1) a").addClass("on");				// 주말반 ON
								...
								<table>
									...
									<tbody>
										<tr>
											<th>교육기간</th>
											<td class="long">
												<!-- #include virtual="/Include/CourseDateTime/Date/Date__CP2_core_Weekend.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__CP2_core_Weekend.jsp"/>
												<!--
											...
											<th>강의시간</th>
											<td class="long">
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__CP2_core_Weekend.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__CP2_core_Weekend.jsp"/>
												<!--
