...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth2.newwrap.no6").addClass("on").removeClass("plus").addClass("minus");
			$(".snb_1709 .newdepth3_wrap.no6").addClass("on").css('display','block');	// if not, the first one will be different from what I expected.
			$(".snb_1709 .newdepth3_wrap.no6 li:eq(0) a").addClass("on");
		});
	</script>
...
<body>
	<div id="Wrapper">
		...
		<div id="Container_Wrap" style="min-height:initial;">
			...
			<div id="Content_Wrap">
				<!-- SNB_Wrap-->
				<!-- #include virtual = "/Include/SNB_CourseShort_1709.asp"-->
				<!-- //SNB_Wrap-->
				<!-- Content -->
				<div id="Content">
								...
								<table>
									...
									<tbody>
										...
										<tr>
											...
											<td>02-3486-3456 <span class="blueTxt">(재직자 환급 문의)</span> </td>
										</tr>
										<!--
										<tr>
