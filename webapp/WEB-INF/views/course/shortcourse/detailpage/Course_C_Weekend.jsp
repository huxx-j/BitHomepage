...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".snb_1709 .newdepth4_wrap.no1").addClass("on").css('display','block');	// C 프로그래밍 SUB - OPEN
								...
								<table style="box-shadow:none !important;">
									...
									<tbody>
										<tr>
											<th>교육기간</th>
											<td class="long">
											<!-- #include virtual="/Include/CourseDateTime/Date/Date__C_Weekend.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__C_Weekend.jsp"/>
											</td>
											<th>강의시간</th>
											<td class="long">
											<!-- #include virtual="/Include/CourseDateTime/Time/Time__C_Weekend.inc" -->
											<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__C_Weekend.jsp"/>
											</td>										
										</tr>
										<tr>
											<th>교육비용</th>
...
<!-- con_wrap1709 -->
						...
						<div class="btn_wrap c">
							<a href="/Register/Request/register_shortCourse.asp?cID=C_Weekend" class="btn mid green1">수강신청</a>
						</div>
						-->
					</section>
				</div>
