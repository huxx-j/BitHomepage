					...
					<section class="section">
									...
									<tbody>
										<tr>
											...
											<td>
												...
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Date/Date__DSci_ExcelMLearn.jsp"/>
											</td>
											<th>강의시간</th>
											<td>
												<!-- #include virtual="/Include/CourseDateTime/Time/Time__DSci_ExcelMLearn.inc" -->
												<c:import url="/WEB-INF/views/Include/CourseDateTime/Time/Time__DSci_ExcelMLearn.jsp"/>
											</td>
										</tr>
										<tr>
											<th>교육비용</th>
						...
						<div class="con_wrap1709" style="z-index:1;"> <!-- otherwise, 환급내용 자세히보기 div와 z-index problem happens -->
							...
							<p>
								...
								<img src="${pageContext.request.contextPath}/assets/Images/img_PrimaXL.png" style="width:130px;"/><br/><br/>
								<b>“실용성 중시”</b><br/><br/>
						...
						<div class="con_wrap1709">
							...
							<p>
								...
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig4_01.png" style="margin-left:10%; width:60%;"/><br/>
								<b>- "주성분 분석은 어떻게 활용할 수 있나요?"</b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig4_02.png" style="margin-left:10%; width:60%;"/><br/>
								<b>- "선형회귀 결과는 어떻게 해석하나요?"</b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig4_03.png" style="margin-left:10%; width:60%;"/><br/>
								<b>- "인공신경망에 대해서 알려주세요"</b><br/>
								<img src="${pageContext.request.contextPath}/assets/Images/Course_DSCIENCE_fig4_04.png" style="margin-left:10%;"/><br/>
							</p>
						</div>
						<!-- //con_wrap1709 -->
