			...
			<div id="Content_Wrap">
				...
				<div id="Content">
					...
					<div style="float:left;">
						<img src="${pageContext.request.contextPath}/assets/Images/Titles/MainPage_Title__국가기간전략산업직종.png" style="float:left; margin-bottom:2px; display:none;" alt="국가기간전략산업직종"/>
						<div style="clear:both;"></div>
