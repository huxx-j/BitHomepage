            ...
            <div id="Content">
                <div class="hGroup1709">
                    <p>
                        ...
                        <img src="${pageContext.request.contextPath}/assets/Images/Icons/icn_ArrowTriangleRight.png"/>SW개발자 후견인 제도
                    </p>
                ...
                <section class="section">
                    ...
                    <div class="con_wrap1709">
                        <h5>후견인 신청방법</h5>
                        <p>
                            - <b><a class="email" href="${pageContext.request.contextPath}/assets/Upload/BITsupporters_apply.docx">후견인 추천서</a></b>를 작성하여 비트교육센터에 <b>이메일(<a href="mailto:job@bit.kr" class="email">job@bit.kr</a>)</b>로 보내주시면 후견대상자에게 연락하여 교육컨설팅 후, 결과를 Feedback 드리겠습니다.
                        </p>
                    </div>
