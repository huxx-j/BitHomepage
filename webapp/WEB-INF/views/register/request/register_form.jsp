...
<form name="applyForm" method="POST" action="${pageContext.request.contextPath}/register/request/register_form_submit">
                                ...
                                <table>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="l">
                                                ...
                                                <select style="width:400px" name="curriculum_no"  onchange="return onChangeSelect1DB(this.value)">
                                                    ...
                                                    <option value="23" selected>C기반 Embedded Linux 시스템 개발자 양성과정</option>
                                                </select>
                                            </td>
                                        </tr>
                                    </c:if>
                                        ...
                                        <tr>
                                            ...
                                            <td class="l">
                                                <select id="select4" style="width:140px" name="startDate" onclick="JavaScript:SelectDateCheck()">
                                                    <option value="0">==선택==</option> <%--과정클릭하면 바뀌게하는 코드 필요--%>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="l">
                                                <select style="width: 140px" name="testLang" disabled>
                                                    <option value="0">과목 선택</option> <%--과정선택하면 시험과목이 나오는걸로..--%>
                                    ...
                                    <c:if test="${cID eq 'bspm'}">
                                        <tr>
                                            ...
                                            <td class="l">
                                                <select id="itemInfo_04" name="testDate" onclick="JavaScript:SelectDateCheck()" style="width:150px">
                                                    <option value="0">=====선택=====</option>
                                                    <option value="20180101">2018-01-01</option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="select1" style="WIDTH: 350px; HEIGHT: 22px" name="curriculum_no" onchange="javascript:onChangeSelect1(this.value)">
                                                    <option value="0">(선택하세요)</option> <%--여긴 하드코딩으로 넣는듯--%>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select id="select4" name="startDate" style="width:160px">
                                                    <option value="0">(설명회를 선택하세요)</option> <%--여기도 하드코딩--%>
                                                    <option value="20180101">2018-01-01</option>
                                                </select><input type=hidden value="<%--<%=totSelectDate%>--%>" name="totselectdate">
                                            </td>
                                        </tr>
                                    ...
                                    <div class="divTable">
                                        <table class="padding2px">
                                            ...
                                            <c:if test="${cID eq 'kuka' or cID eq 'industry40' or cID eq 'employment' or cID eq 'expert' or cID eq 'chung'}">
                                                <tr>
                                                    <th>수행프로젝트 제목/내용</th>
                                                    <td colspan="6" class="l"><textarea onkeyup="chklen(this,'학위논문')"  name="thesis"  style="width:100%; height:110px; padding:0px; border:0px; resize: none">${userInfo.thesis}</textarea></td>
                                                </tr>
                                            </c:if>
                                            </tbody>
                                        </table>
                                        ...
                                        <tr>
                                            ...
                                            <td class="c">
                                                <select name="langScoreType1">
                                                    ...
                                                    <option ${langMil.langScore1[0] eq "TOEIC(영어)" ? "selected" : ""} value="TOEIC(영어)">TOEIC</option>
                                                    <option ${langMil.langScore1[0] eq "TOFEL(영어)" ? "selected" : ""} value="TOFEL(영어)">TOFEL</option>
                                                    <option ${langMil.langScore1[0] eq "TOEIC Speaking(영어)" ? "selected" : ""} value="TOEIC Speaking(영어)">TOEIC Speaking</option>
                                                    <option ${langMil.langScore1[0] eq "OPIc(영어)" ? "selected" : ""} value="OPIc(영어)">OPIc</option>
                                                    <option ${langMil.langScore1[0] eq "ETAT(영어)" ? "selected" : ""} value="ETAT(영어)">ETAT</option>
                                                    <option ${langMil.langScore1[0] eq "TEPS(영어)" ? "selected" : ""} value="TEPS(영어)">TEPS</option>
                                                    <option ${langMil.langScore1[0] eq "G-TELP(영어)" ? "selected" : ""} value="G-TELP(영어)">G-TELP</option>
                                                    <option ${langMil.langScore1[0] eq "GRE(영어)" ? "selected" : ""} value="GRE(영어)">GRE</option>
                                                    <option ${langMil.langScore1[0] eq "JTRA(일어)" ? "selected" : ""} value="JTRA(일어)">JTRA</option>
                                                    <option ${langMil.langScore1[0] eq "JPT(일어)" ? "selected" : ""} value="JPT(일어)">JPT</option>
                                                    <option ${langMil.langScore1[0] eq "HSK(중국어)" ? "selected" : ""} value="HSK(중국어)">HSK</option>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td class="c">
                                                <select name="langScoreType2">
                                                    ...
                                                    <option ${langMil.langScore2[0] eq "TOEIC(영어)" ? "selected" : ""} value="TOEIC(영어)">TOEIC</option>
                                                    <option ${langMil.langScore2[0] eq "TOFEL(영어)" ? "selected" : ""} value="TOFEL(영어)">TOFEL</option>
                                                    <option ${langMil.langScore2[0] eq "TOEIC Speaking(영어)" ? "selected" : ""} value="TOEIC Speaking(영어)">TOEIC Speaking</option>
                                                    <option ${langMil.langScore2[0] eq "OPIc(영어)" ? "selected" : ""} value="OPIc(영어)">OPIc</option>
                                                    <option ${langMil.langScore2[0] eq "ETAT(영어)" ? "selected" : ""} value="ETAT(영어)">ETAT</option>
                                                    <option ${langMil.langScore2[0] eq "TEPS(영어)" ? "selected" : ""} value="TEPS(영어)">TEPS</option>
                                                    <option ${langMil.langScore2[0] eq "G-TELP(영어)" ? "selected" : ""} value="G-TELP(영어)">G-TELP</option>
                                                    <option ${langMil.langScore2[0] eq "GRE(영어)" ? "selected" : ""} value="GRE(영어)">GRE</option>
                                                    <option ${langMil.langScore2[0] eq "JTRA(일어)" ? "selected" : ""} value="JTRA(일어)">JTRA</option>
                                                    <option ${langMil.langScore2[0] eq "JPT(일어)" ? "selected" : ""} value="JPT(일어)">JPT</option>
                                                    <option ${langMil.langScore2[0] eq "HSK(중국어)" ? "selected" : ""} value="HSK(중국어)">HSK</option>
                                                </select>
                                                <input name="langScore2" value="${langMil.langScore2[1] != null or langMil.langScore1[1] != '' ? langMil.langScore2[1] : ""}" style="WIDTH: 25px">점
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="divTable">
                                    <table class="padding2px">
                                        ...
                                        <c:forEach items="${licence}" var="vo" varStatus="cnt">
                                            <tr>
                                                <td class="c">
                                                    <input type="hidden" name="license_no_${cnt.index}" value="${vo.license_no eq null or vo.license_no eq '' ? '0' : vo.license_no}">
