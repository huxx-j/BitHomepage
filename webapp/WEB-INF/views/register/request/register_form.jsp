...
<form name="ExpertApp" method="POST" action="${pageContext.request.contextPath}/Register/Request/register_kukka_insert1.asp">
            ...
            <div id="Content_Wrap">
                ...
                <div id="Content">
                    ...
                    <div class="con_wrap1709">
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" class="l">
                                                <select style="width: 140px" name="testLang"  disabled>
                                                    <option value="0">지원과정 선택</option> <%--과정선택하면 시험과목이 나오는걸로..--%>
                                                </select>
                                            </td>
                                        </tr>
                                    </c:if>
                        ...
                        <%--<c:if test="${cID eq 'kaku' and cID eq 'industry40' and cID eq 'employment' and cID eq 'expert' and cID eq 'chung'}">--%>
                            <%--<tr>--%>
                                <%--<th>수행프로젝트 제목/내용</th>--%>
                                <%--<td colspan="6" class="l"><textarea onkeyup="chklen(this,'학위논문')"  name="papertext"  style="width:100%; height:110px; padding:0px; border:0px">${userInfo.thesis}</textarea></td>--%>
                            <%--</tr>--%>
                        <%--</c:if>--%>
                        <%--</tbody>--%>
                    <%--</table>--%>
                        ...
                        <section class="section">
                            ...
                            <div class="divTable">
                                <table class="padding2px">
                                    ...
                                    <tr>
                                        <td class="c">
                                            <select style="WIDTH: 55px" name="secLang1">
                        ...
                        <section class="section">
                            ...
                            <div class="divTable">
                                <table class="padding2px">
                                    ...
                                    <tr>
                                        <td class="c">
                                            <input type="text" name="MilYearFr1" value="${langMil.startYear}" maxlength="4" onChange="JavaScript:chknext(this)"  onKeyPress="onlyNumber();" style="width:30px">
                                            년
                                        ...
                                        <td class="c">
                                            <input type="text" name="MilYearFr2" value="${langMil.endYear}" maxlength="4" onChange="JavaScript:chknext(this)"  onKeyPress="onlyNumber();" style="width:30px">
                                            년
                        ...
                        <%--<section class="section">--%>
                            ...
                            <%--<div class="divTable">--%>
                                <%--<table class="padding2px">--%>
                                    ...
                                    <%--<tr>--%>
                                        <%--<td>--%>
                                            <%--<textarea onBlur="chklen_plan(this)" name="hopetext" style="width:100%; height:100px; padding:0px; border:0px; resize: none" >${hope.afterPlan}</textarea>--%>
                                        <%--</td>--%>
                                        <%--<td>--%>
                                            <%--&lt;%&ndash;("YearMonth")&"일 "&Rs("CourseID")&"과정 "&Rs("selectresult")&"<br><b>면접의견</b>:"&Rs("IntervOpinion")&"<br>"&ndash;%&gt;--%>
                                        <%--</td>--%>
                                    <%--</tr>--%>
                                    <%--</tbody>--%>
                                <%--</table>--%>
                            ...
                            <section class="section mar_t40">
                                ...
                                <div class="divTable">
                                    <table summary="학력등록정보 - 기간, 학교, 소재지, 학위, 전공, 부전공, 졸업구분">
                                        ...
                                        <tr>
                                            <td class="l">
                                                <input type="radio" name="hope"> 희망함
                                                <input type="radio" name="hope" class="mar_l20"> 희망안함
                                            </td>
                                        </tr>
                                        </tbody>
                                    </table>
