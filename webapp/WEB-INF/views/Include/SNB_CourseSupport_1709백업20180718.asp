...
<nav id="SNB_Wrap_1709">
	<h3 style="line-height:30px;">국비지원무료과정<br/>과정안내 </h3>
	<ul class="snb_1709">
		<style>
			.dnone {
		...
		<li>
			...
			<ul class="newdepth2_wrap no2" style="min-height:130px;">
				...
				<li><a href="/Course/Kukka/Course_Kukka_RaspberryPiIoTService_2018.asp" style="height:24px; padding-right:10px;" class="newdepth2 long">라즈베리파이를 활용한 IoT 서비스 고급인력 양성과정</a></li>
				<li><a href="/Course/Kukka/Course_Kukka_FinTech_2018.asp" style="height:24px; padding-right:10px;" class="newdepth2 long">금융 IT기반 핀테크 전문가 양성과정</a></li>
				...
				<!--<li><a href="/Course/Kukka/Course_Kukka_JavaBigData_2018.asp" style="height:28px;" class="newdepth2 long">JAVA 기반 빅데이터 분석을 위한 개발자 양성과정</a></li>-->
		...
		<li>
			<a href="/Course/Employ/Course_Employ.asp" onclick="return onclickEmploy();" class="newdepth1">신입사원 채용교육</a>
			<ul class="newdepth2_wrap no3">
				<li><a href="/Course/Employ/Course_Employ.asp" class="newdepth2">신입사원 채용교육 소개</a></li>
				<li><a href="/Course/Employ/Course_Employ_ITtelecom.asp" class="newdepth2">㈜아이티텔레콤</a></li>
				<li><a href="/Course/Employ/Course_Employ_BAinfra.asp" class="newdepth2">㈜비에이인프라</a></li>
				<li><a href="/Course/Employ/Course_Employ_ivis.asp" class="newdepth2">㈜아이비스</a></li>
				<li><a href="/Course/Employ/Course_Employ_BitComputer.asp" class="newdepth2">㈜비트컴퓨터</a></li>
				<li><a href="/Course/Employ/Course_Employ_AurosTech.asp" class="newdepth2">㈜오로스테크놀로지</a></li>
				<li><a href="/Course/Employ/Course_Employ_PSK.asp" class="newdepth2">㈜피에스케이</a></li>
				<li><a href="/Course/Employ/Course_Employ_BizTechPartners.asp" class="newdepth2">㈜비즈테크파트너스</a></li>
				<li><a href="/Course/Employ/Course_Employ_TaehaMechatronics.asp" class="newdepth2">㈜태하메카트로닉스</a></li>
				<li class="dnone"><a href="/Course/Employ/Course_Employ_LEETECH.asp" class="newdepth2">㈜리텍</a></li>
				<li class="dnone"><a href="/Course/Employ/Course_Employ_voiceye.asp" class="newdepth2">㈜보이스아이</a></li>
				<li class="dnone"><a href="/Course/Employ/Course_Employ_Cafe24.asp" class="newdepth2">㈜카페24</a></li>
