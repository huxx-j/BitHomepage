...
<div id="Footer_Outer_Wrap" style="border-bottom:1px solid #516077; margin-top:50px; min-width:960px;">
    <div style="width:960px; margin:0 auto; ">
        ...
        <div style="float:right; height:26px; ">
            <a href="http://bitacademy.blog.me" target="_blank" style="margin-right:7px;"><img src="${pageContext.request.contextPath}/assets/Images/Btns/btn_footer_Blog.png"/></a>
            <a href="https://www.facebook.com/Bitschool" target="_blank" style="margin-right:7px;"><img src="${pageContext.request.contextPath}/assets/Images/Btns/btn_footer_Facebook.png"/></a>
            <a href="https://twitter.com/bit_academy" target="_blank" ><img src="${pageContext.request.contextPath}/assets/Images/Btns/btn_footer_Twitter.png"/></a>
        </div>
...
<div id="Footer_Outer_Wrap" style="min-width:960px;">
    <div style="width:960px; margin:0 auto; height:180px; overflow-y:hidden;">
        <div class="fl" style="background-color:#122139; height:180px; padding-top:30px; padding-left:15px; font-size:13px; ">
            <div>
                <a href="#"><img src="${pageContext.request.contextPath}/assets/Images/Btns/btn_footer_LogoBitacademy.png"/></a>
        ...
        <div style="float:right;">
            <img src="${pageContext.request.contextPath}/assets/Images/Btns/btn_footer_KakaoTalk.png"/>
        </div>
        <div style="clear:both;"></div>
    </div>
</div>
