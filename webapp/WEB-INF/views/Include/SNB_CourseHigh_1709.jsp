	...
	<ul class="snb_1709">
		...
		<li>
			...
			<ul class="newdepth2_wrap no2">
				<li><a href="/course/localCampus/localCampus_Daejeon_introduction" class="newdepth2 no1">대전캠퍼스 소개</a></li>
				<li><a href="/course/localCampus/DetailPage/Daejeon_windowNet" class="newdepth2 no1">윈도우 닷넷 고급과정</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no3">
				<li><a href="/course/localCampus/localCampus_Busan_introduction" class="newdepth2 no1">부산캠퍼스 소개</a></li>
				<li><a href="/course/localCampus/Busan_javaHigh" class="newdepth2 no1">웹&amp;모바일 고급과정</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no4">
				<li><a href="/course/localCampus/localCampus_Gunpo_introduction" class="newdepth2 no1">군포캠퍼스 소개</a></li>
				<li><a href="/course/localCampus/Gunpo_windowNet" class="newdepth2 no1">윈도우 닷넷 고급과정</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no4">
				<li><a href="/course/localCampus/localCampus_Gimhae_introduction" class="newdepth2 no1">김해캠퍼스 소개</a></li>
