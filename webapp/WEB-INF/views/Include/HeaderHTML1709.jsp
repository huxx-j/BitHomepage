...
<div id="Container">
	<div id="Header_Outer_Wrap" style="min-width: 960px;">
		...
		<div id="mainTopBar">
			<div style="width: 960px; margin: 0 auto;">
				<div class="fl"
					style="color: #d2d2d4; margin-left: 12px; margin-top: 14px;">입학이
					긍지가 되고 수료가 날개가 되는&nbsp;</div>
				<div class="fl" style="color: #1498be; margin-top: 14px;">상위1%전문가
					양성을 위한 교육</div>
		...
		<div id="Header_Wrap1709">
			...
			<div id="mainLogoBar">
				<div style="float: left;">
					<a href="/index"><img
						src="${pageContext.request.contextPath}/assets/Images/MainPage__Logo.png"
						style="margin-top: 11px; margin-left: 12px;" /></a>
				</div>
				<!--
                <div style="float:left;">
	...
	<div id="Header_Outer_Wrap"
		style="border-top: 1px solid #e8e8e8; border-bottom: 3px solid #1b499b; height: 54px; width: 100%;">
		<!-- 1px solid #e8e8e8;  -->
		<div id="Header_Wrap1709">
			<!--TopMenuBar-->
			<div id="mainTopMenuBar">
				...
				<img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu2off.png" />
				<img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu3off.png" />
				<img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu4off.png" />
				<img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu5off.png"
					h_ref="/course/kukka/Course_Support" /> <img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu6off.png" />
				<img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu7off.png"
					h_ref="/employment/employment_jobCenter" /> <img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu8off.png"
					h_ref="/course/employ/Course_Employ" /> <img class="mainmenu"
					src="${pageContext.request.contextPath}/assets/Images/Menus/2/MainPage_Menu__menu9off.png"
					h_ref="/course/license/Course_Licenses" />
				<div style="clear: both;"></div>
