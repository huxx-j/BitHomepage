	...
	<ul class="snb_1709">
			...
			<ul class="newdepth2_wrap no1">
				...
				<li>
					...
					<ul class="newdepth3_wrap no2">
						<li><a href="/Course/localCampus/localCampus_Daejeon_introduction.asp" class="newdepth3">대전캠퍼스 소개</a></li>
				...
				<li>
					...
					<ul class="newdepth3_wrap no3">
						<li><a href="/Course/localCampus/localCampus_Busan_introduction.asp" class="newdepth3">부산캠퍼스 소개</a></li>
						...
						<li><a href="/Course/localCampus/DetailPage/Busan_c2.asp" class="newdepth3">자료구조/알고리즘</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="newdepth3_wrap no4">
						<li><a href="/Course/localCampus/localCampus_Gunpo_introduction.asp" class="newdepth3">군포캠퍼스 소개</a></li>
						...
						<li><a href="/Course/localCampus/DetailPage/Gunpo_c2.asp" class="newdepth3">자료구조/알고리즘</a></li>
					</ul>
				</li>
				...
				<li>
					...
					<ul class="newdepth3_wrap no5">
						<li><a href="/Course/localCampus/localCampus_Gimhae_introduction.asp" class="newdepth3">김해캠퍼스 소개</a></li>
						...
						<li><a href="/Course/localCampus/DetailPage/Gimhae_c2.asp" class="newdepth3">자료구조/알고리즘</a></li>
					</ul>
				</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no2" style="height:203px;">
				...
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_DSCIENCE_AnalysisMachineLearning.asp" class="newdepth2 no1">R을 사용한 데이터 분석과 <br/>머신러닝 (초급)</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_DSCIENCE_AnalysisMachineLearning2.asp" class="newdepth2 no2">R을 사용한 데이터 분석과 <br/>머신러닝 (중급)</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_DSCIENCE_PracticalMachineLearningPython.asp" class="newdepth2 no3">Python을 활용한 실용머신러닝 - 초급</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_DSCIENCE_ExcelMachineLearning.asp" class="newdepth2 no4">즉각 활용하는 Excel을 사용한 데이터 사이언스 입문</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_AWSCloudWeb2.asp" class="newdepth2 no5">AWS를 활용한 클라우드 기반 웹 개발</a></li>
			</ul>
		</li>			
		...
		<li>
			...
			<ul class="newdepth2_wrap no3" style="height:37px;">
				...
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_Blockchain_HyperConnected.asp" class="newdepth2 no1">블록체인 - 초연결 기술과 규제</a></li>
			</ul>
		</li>			
		...
		<li>
			...
			<ul class="newdepth2_wrap no4">
				<!-- newwrap no4 : Java -->
				<li><a href="/Course/ShortCourse/DetailPage/Course_servletJsp.asp" class="newdepth2 no1">Servlet &amp; JSP 프로그래밍</a></li>
				<li><a href="/Course/ShortCourse/DetailPage/Course_spring.asp" class="newdepth2 no2 ">Spring Framework 과정</a></li>
				<li style="height:50px;"><a href="/Course/ShortCourse/DetailPage/Course_aiojava.asp" class="newdepth2 no3">All-in-One Java Application 개발</a></li>
			</ul>
		</li>			
		...
		<li>
			...
			<ul class="newdepth2_wrap no5" style="min-height:306px;">
				<!-- newwrap no5 : JS -->
				<li><a href="/Course/ShortCourse/DetailPage/Course_HTML5.asp" class="newdepth2 no2">웹개발자를 위한 HTML5(HTML5+CSS3)</a></li>
				<li style="height:28px;"><a href="javascript:alert('준비중입니다. 문의(02-3486-3456)');" class="newdepth2 no3">실전 jQuery</a></li>
				<li><a href="/Course/ShortCourse/DetailPage/Course_JavaScript.asp" class="newdepth2 no4">웹개발자를 위한 JavaScript &amp; Ajax</a></li>
				<li style="height:28px;"><a href="/Course/ShortCourse/DetailPage/Course_WebPublishing.asp" class="newdepth2 no5">Web Publishing 실무</a></li>
				...
				<li><a href="/Course/ShortCourse/DetailPage/Course_Nodejs.asp" class="newdepth2 no9">객체지향 JavaScript와 Node.js 프로그래밍</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no6" style="min-height:238px;">
				<!-- newwrap no6 : DB -->
				<li><a href="/Course/ShortCourse/DetailPage/Course_SearchEngine.asp" class="newdepth2 no1">맞춤형 검색엔진<!-- 과정--></a></li>
				<li><a href="/Course/ShortCourse/DetailPage/Course_dataBaseModeling.asp" class="newdepth2 no2">데이터베이스 모델링</a></li>
				<li><a href="/Course/ShortCourse/DetailPage/Course_dataBase.asp" class="newdepth2 no3">데이터베이스 성능튜닝</a></li>
				...
				<li><a href="/Course/ShortCourse/DetailPage/Course_sqlJdbc.asp" class="newdepth2 no6">오라클과 데이터베이스 연동 프로그래밍</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no7" style="min-height:124px;">
				<!-- newwrap no7 : PM -->
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_Agile4Developer.asp" class="newdepth2 no1">Agile 소프트웨어 개발 실무</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_ArchitectureBasic.asp" class="newdepth2 no2">소프트웨어 아키텍처 입문</a></li>
				<li class="long"><a href="/Course/ShortCourse/DetailPage/Course_ITIL.asp" class="newdepth2 no3">ITILv3 기반 IT Service Management</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no8">
				<!-- newwrap no8 : Mobile -->
				<li><a href="/Course/ShortCourse/DetailPage/Course_Android.asp" class="newdepth2 no1">안드로이드 앱 개발</a></li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no9" style="min-height:220px;">
				...
				<li style="height:28px;"><a href="/Course/ShortCourse/DetailPage/Course_javaPlan.asp" class="newdepth2 no1">Java 설계과정</a></li>
				<li style="height:38px;"><a href="/Course/ShortCourse/DetailPage/Course_realUml.asp" class="newdepth2 no2">UML 실전에서는 이것만 쓴다</a></li>
				<li style="height:28px;"><a href="/Course/ShortCourse/DetailPage/Course_uml.asp" class="newdepth2 no3">실전! 분석과정</a></li>
				<li style="height:38px;"><a href="/Course/ShortCourse/DetailPage/Course_designPattern.asp" class="newdepth2 no4">객체지향 개념과 <br/>디자인 패턴</a></li>
				<li style="height:38px;" class="long"><a href="/Course/ShortCourse/DetailPage/Course_codingTuning.asp" class="newdepth2 no5">Java JDBC 기반의 SQL <br/>성능튜닝</a></li>
				<li style="height:38px;" class="long"><a href="/Course/ShortCourse/DetailPage/Course_OptimizationAlgorithms.asp" class="newdepth2 no6">최적화 알고리즘을 통한 <br/>SW개발 역량 강화</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no10" style="min-height:86px;">
				...
				<li><a href="/Course/ShortCourse/DetailPage/Course_RaspberryPi.asp" class="newdepth2 no1">오픈소스 라즈베리파이를 활용한 IoT 과정</a></li>
				<li><a href="/Course/ShortCourse/DetailPage/Course_StorageSystem_FMBased.asp" class="newdepth2 no2">Flash Memory기반 Storage System</a></li>
			</ul>
		</li>
