...
<nav id="SNB_Wrap_1709">
	...
	<ul class="snb_1709">
		<li><a href="/Course/Expert/Course_Expert_JavaExpert.asp" class="newdepth1">자바 전문가과정</a></li>
		<li><a href="javascript:alert('준비중입니다. (문의 02-3486-3456)');" class="newdepth1">윈도우 닷넷 전문가과정</a></li>
		<li><a href="/Course/Expert/Course_Expert_Embedded.asp" class="newdepth1" style="letter-spacing:-1px;">임베디드 시스템 전문가과정</a></li>
