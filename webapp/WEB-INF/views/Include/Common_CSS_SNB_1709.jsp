<style>
    ...
    */
    ...
    .snb_1709 li a.newdepth1 {
        padding: 17px 10px;
        background: url(/assets/Images/Common/ico_snbBtnDown.png) 195px 12px no-repeat;
    ...
    */
    .snb_1709 .newwrap.up {
        background: #f7f7f7 url(/assets/Images/Common/ico_snbBtnUp.png) 175px 7px no-repeat;
    }
    .snb_1709 .newwrap.down {
        background: url(/assets/Images/Common/ico_snbBtnDown.png) 175px 6px no-repeat;
    }
    .snb_1709 .newwrap.plus {
        background: #f7f7f7 url(/assets/Images/Icons/icn_Plus.png) 130px 5px no-repeat;
    }
    .snb_1709 .newwrap.minus {
        background: url(/assets/Images/Icons/icn_Minus.png) 130px 5px no-repeat;
    }
