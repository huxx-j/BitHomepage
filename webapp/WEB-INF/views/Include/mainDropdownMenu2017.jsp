		...
		<!-- main dropdown menu -->
			...
			<div class="mainDropdownMenu depth0 no1" >
				...
				<div class="mainDropdownMenu depth3 no1 fl">
					<div class="divTop1"></div>
					<div class="divTop2"></div>
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_C"><div class="divMiddleInner" style="width:150px;  background-image: url();">C Master</div></div>
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_java"><div class="divMiddleInner" style="width:150px;  background-image: url();">Java 프로그래밍</div></div>
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_cPlus"><div class="divMiddleInner" style="width:150px;  background-image: url();">C++ 프로그래밍</div></div>
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_Python"><div class="divMiddleInner" style="width:150px;  background-image: url();">Python 프로그래밍</div></div>
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_cSharp"><div class="divMiddleInner" style="width:150px;  background-image: url();">C# 프로그래밍</div></div>
					...
					<div class="divMiddle" href="/course/shortcourse/detailPage/Course_SelfLearning"><div class="divMiddleInner" style="width:150px; background-image: url();">SW 자율학습 지도 커뮤니티</div></div>
			...
			<div class="mainDropdownMenu depth0 no2" >
				...
				<div class="mainDropdownMenu depth2 no3 fl">
					...
					<div class="divMiddle" href="/course/localCampus/DetailPage/Busan_javaHigh">
				...
				<div class="mainDropdownMenu depth2 no4 fl">
					...
					<div class="divMiddle" href="/course/localCampus/DetailPage/Gunpo_windowNet">
						<div class="divMiddleInner" style="width:140px;">윈도우 닷넷 고급과정</div>
					</div>
					<div class="divBottom"></div>
				</div>
