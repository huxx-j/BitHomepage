...
#LNB_Wrap .lnb .depth1 > a {
	background: none;
}
#LNB_Wrap .lnb .depth1 a {
	font-size:16pt;
}
#LNB_Wrap .lnb .depth2 a {
	font-size:14px;
}
.gnb li a {
	font-size:14px;
...
<div id="Header_Wrap">	
	<header id="Header">
		<h1><img src="/Images/Common/h1_01.png" alt="입학이 긍지가 되고 수료가 날개가 되는 상위1% 전문가를 만드는 비트교육센터">
			<!--
		...
		<nav id="GNB_Wrap">
			<div style="float:right;">
				...
				<ul class="gnb" style="margin-right:5px; margin-top:10px;">
		...
		<div style="float:right;">
			<nav id="LNB_Wrap">
				<ul class="lnb"">
					<li class="depth1 no1"><a href="/Course/Expert/Course_Expert.asp" title="과정안내" class="depth1_1" style="margin-top:10px;">교육과정</a>
						<!--<ul class="depth2 no1">-->
						<ul class="depth2 no1" style="top:46px;">
							<!--<li class="gnbImg"></li>-->
							<li>
							...
							<li>
								...
								<ul class="depth3 no4">
									...
									<li style="display:none;"><a href="/Course/ShortCourse/DetailPage/Course_C_Weekend.asp">C Programming (주말)</a></li>
									...
									<li style="display:none;"><a href="/Course/ShortCourse/DetailPage/Course_Java_Weekend.asp">JAVA Programming (주말)</a></li>
									...
									<!--<li><a href="/Course/shortCourse/DetailPage/Course_swVisualization.asp">SW Visualization</a></li>-->
									<li><a href="/Course/shortCourse/Course_shortCourse_javaWeb.asp">Java Web</a></li>
									<li><a href="/Course/shortCourse/Course_shortCourse_ITPM.asp">IT PM</a></li>
									<li><a href="/Course/shortCourse/Course_shortCourse_mobile.asp">Mobile</a></li>
									<li><a href="/Course/shortCourse/Course_shortCourse_sw.asp">SW공학</a></li>
									<li><a href="/Course/shortCourse/Course_shortCourse_dataBase.asp">DataBase</a></li>
					...
					<li class="depth1 no2"><a href="/Register/register_info.asp" title="수강신청" class="depth1_2" style="margin-top:10px;">수강신청</a>
						<ul class="depth2 no2" style="top:46px;">
					...
					<li class="depth1 no3"><a href="/Employment/employment_jobCenter.asp" title="취업" class="depth1_3" style="margin-top:10px;">취업</a>
						<ul class="depth2 no3" style="top:46px;">
					...
					<li class="depth1 no4"><a href="/Education/Education_info.asp" title="문의" class="depth1_4" style="margin-top:10px;">문의</a>
						<ul class="depth2 no4" style="top:46px;">
