...
<nav id="SNB_Wrap_1702">
	<h3 style="text-align:center; padding-left:0px;"><img src="/Images/Common/ico_clipboard2_128.png" style="height:32px; margin-right:3px; margin-top:-7px;"/> 과정안내 </h3>
	<ul class="snb_1702">
		<style>
			.dnone {
		...
		<li>
			...
			<ul class="newdepth2_wrap no1">
				...
				<!--<li><a href="/Course/Expert/Course_Expert_BigDataSystem.asp" class="newdepth2">빅데이터 시스템 개발 전문가과정</a></li>-->
		...
		<li>
			...
			<ul class="newdepth2_wrap no2">
				...
				<li><a href="/Course/Employ/Course_Employ_Semics.asp" class="newdepth2">㈜쎄믹스 <span class="redTxt">[모집중]</span></a></li>
				<li><a href="/Course/Employ/Course_Employ_QMC.asp" class="newdepth2">㈜큐엠씨 <span class="redTxt">[모집중]</span></a></li>
				<li><a href="/Course/Employ/Course_Employ_DareInc.asp" class="newdepth2">㈜다래아이엔씨 <span class="redTxt">[모집중]</span></a></li>
				...
				<!--<li><a href="/Course/Employ/Course_Employ_BnEpartners.asp" class="newdepth2">㈜비즈테크파트너스 <span class="redTxt">[모집중]</span></a></li>-->
				...
				<!--<li><a href="/Course/Employ/Course_Employ_diginc.asp " class="depth2 dnone">㈜디지엔스 [상시채용]</a></li>-->
				<li><a href="/Course/BITsupporters_2016.asp" class="newdepth2">SW개발자 후견인 제도</a></li>
			</ul>
		</li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no4">
				...
				<li><a href="/Course/Kukka/Course_Kukka_2016.asp" class="newdepth2">2017년 국비지원 무료과정 소개</a></li>
				<li><a href="/Course/Kukka/Course_Kukka_JavaBigData_2016.asp" class="newdepth2">JAVA 기반 빅데이터 처리를 위한 분산정보시스템 개발자 양성과정</a></li>
				<li><a href="/Course/Kukka/Course_Kukka_EmbeddedIoT_2016.asp" class="newdepth2">IoT 디바이스 개발을 위한 임베디드 시스템 개발자 양성과정</a></li>
		...
		<li>
			...
			<ul class="newdepth2_wrap no5">
				...
				<li style="display:none;"><a href="#" class="depth2 btn sml blue mar_l5" >2015년 겨울방학 특강 일정안내</a></li>
				...
				<ul class="newdepth3_wrap no1">
					<li><a href="/Course/ShortCourse/DetailPage/Course_c.asp" class="newdepth3">C Programming 평일</a></li>
					<li><a href="/Course/ShortCourse/DetailPage/Course_C_Weekend.asp" class="newdepth3">C Programming 주말</a></li>
					<li><a href="/Course/ShortCourse/DetailPage/Course_c2.asp" class="newdepth3">자료구조 및 초급 알고리즘</a></li>
					<li><a href="/Course/ShortCourse/DetailPage/Course_AlgorithmIntermediate.asp" class="newdepth3">문제해결을 위한 중급 알고리즘</a></li>
					<li><a href="/Course/ShortCourse/DetailPage/Course_AlgorithmAdvanced.asp" class="newdepth3">문제해결을 위한 고급 알고리즘</a></li>
				</ul>
				...
				<ul class="newdepth3_wrap no8">
					<li><a href="/Course/ShortCourse/DetailPage/Course_java.asp" class="newdepth2">JAVA Programming 평일</a></li>
					<li><a href="/Course/ShortCourse/DetailPage/Course_Java_Weekend.asp" class="newdepth2">JAVA Programming 주말</a></li>
				</ul>
		...
		-->
		<li>
			<a href="#this" class="newdepth1" style="letter-spacing:-0.6px;">소프트웨어 전문교원양성과정</a>
			<ul class="newdepth2_wrap no8">
				<li><a href="/Course/Teachers/Course_Teachers.asp" class="newdepth2">전문교원양성과정 소개</a></li>
				<li><a href="/Course/Teachers/Course_RaspberryPi_iFrame.asp" class="newdepth2">라즈베리파이를 이용한 인터넷 액자 만들기</a></li>
				<!--
		...
		<li class="last">
			...
			<ul class="newdepth2_wrap no9">
				...
				<li><a href="/Course/License/Course_Licenses.asp" class="newdepth2">BSPM(BIT Software Programming Master)자격증</a></li>
			</ul>
		</li>
		<!--
		<li style="display:none;">
