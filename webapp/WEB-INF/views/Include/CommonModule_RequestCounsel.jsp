...
<div class="con_wrap1709">
	...
	<form id="formRequestCounsel" class="mar_t30" method="post" action="/WEB-INF/views/Include/Common_RequestCounselComplete.jsp">
		<img src="${pageContext.request.contextPath}/assets/Images/requestCounselTop720px.png"/>
		...
		<img src="${pageContext.request.contextPath}/assets/Images/requestCounselBottom720px.png" usemap="#counselMap"/>
		<map name="counselMap">
