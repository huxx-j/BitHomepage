            ...
            <div id="Content">
                ...
                <section class="section">
                    ...
                    <div class="con_wrap1709 first">
                        <p><img src="${pageContext.request.contextPath}/assets/Images/Content/img_employment_01_01.jpg" alt="비트교육센터 취업지원센터 안내 - 비트교육센터 취업지원센터는 비트교육센터의 체계적인 취업시스템을 도입하여 SW개발 분야에 특화된 전문 SW취업 사이트로 신입사원채용프로그램을  통해 기업과 인재 모두에게 맞춤형 채용을 제공하고자 합니다."></p>
