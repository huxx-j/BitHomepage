					...
					<section class="section" style="font-family:'Nanum Gothic Bold'; font-size:11pt;">
						...
						<div class="con_wrap1709 first last">
							...
							<div style="float:left; width:25%; ">
								<img src="/Images/007.jpg" style="width:179px; border:1px solid #a8a8a8; border-radius:1pt;"/>
							</div>
							<div style="clear:both;"></div>
							
							<div style="margin-left:1px; margin-top:30px;">
								<video src="/Videos/video_bitschool_CM_20130714_600k.mp4" type="video/mp4" controls loop autoplay width="720">cannot play this video</video>
...
<%
	...
	Session("RefererURL") = Referer
	
	'response.write("RefererURL : " & Session("RefererURL"))
%>		
		<!-- Footer_Wrap -->
