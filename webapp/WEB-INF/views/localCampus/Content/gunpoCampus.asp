...
<script type="text/javascript">
	$(function(){
		ajaxLoad('#ConDetail', '', '/localCampus/Content/Tab/gunpo_courseInfo.asp');
	})
</script>
				...
				<section>
					<div class="tap_header">
						<ul class="tapMenu">
							...
							<li class="on"><a href="#this" title="모집중인과정" onClick="javascript:ajaxLoad('#ConDetail', '', '/localCampus/Content/Tab/gunpo_courseInfo.asp');">모집중인과정</a></li>
							<li><a href="#this" title="오시는길" onClick="javascript:ajaxLoad('#ConDetail', '', '/localCampus/Content/Tab/gunpo_location.asp');">오시는길</a></li>
						</ul>
					</div>
