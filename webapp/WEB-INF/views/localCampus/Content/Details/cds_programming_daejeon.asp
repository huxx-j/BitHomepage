		...
		<div id="Container">
			<div id="Content" class="sub">
				...
				<section class="section mar_t40">
					...
					<div class="form_type1 bor_solid_top10_green">
						<table border="1" class="table_col_type1">
							<caption>대전캠퍼스 자료구조/알고리즘 일정</caption>
							<colgroup>
								<col style="width:15%">
								<col style="width:35%">
								<col style="width:15%">
							...
							<tbody>
								<tr>
									<th scope="row">교육과목명</th>
									<td colspan="3" class="l">자료구조/알고리즘</td>
								</tr>
								<tr>
									<th scope="row">강의일정</th>
									<td class="l">2014.10.24 ~ 2014.11.20 (60시간/20일)</td>
				...
				<section class="section infoCon">
					<dl>
						<dt>교육소개</dt>
						<dd>프로그래밍 언어는 배웠으나 활용을 못하는 분들을 위한 과정입니다. <br>
						이 강좌를 통해 문법을 올바르게 사용하고 또한 생각하는 대로 프로그램을 작성할 수 있도록 도와드리며 실습위주의 교육운영으로 효율적인 프로그램 코드를 작성하는 능력을 향상시켜드립니다.</dd>
					</dl>
					<dl>
						<dt>교육목표</dt>
						<dd>
					...
					<dl class="bg_none">
						...
						<dd>
							<div class="form_type1 bor_solid_top10_green">
								<table border="1" class="table_col_type1">
									<caption>대전캠퍼스 자료구조/알고리즘교육내용</caption>
									<colgroup>
										<col style="width:30%">
										<col style="width:25%">
										<col style="width:45%">
