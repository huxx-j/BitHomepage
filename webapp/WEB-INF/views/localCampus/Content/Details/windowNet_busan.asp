				...
				<section class="section mar_t40">
					...
					<div class="form_type1 bor_solid_top10_green">
						<table class="table_col_type1">
							<caption>부산캠퍼스 Windows .NET 고급과정 일정</caption>
							<colgroup>
								<col style="width:15%">
								<col style="width:35%">
								<col style="width:15%">
							...
							<tbody>
								<tr>
									...
									<td colspan="3" class="l">Windows .NET 고급과정</td>
								</tr>
								<tr>
									<th scope="row">강의일정</th>
									<td class="l">2014.09.22 ~ 2015.02.28 (6개월)</td>
									<th scope="row">강의시간</th>
									<td class="l">09:00 ~ 16:00 (6시간)</td>
								</tr>
								<tr>
									<th scope="row">교육비</th>
									<td class="l">3,700,000원</td>
				...
				<section class="section infoCon">
					...
					<dl class="bg_none">
						...
						<dd>
							<div class="form_type1 bor_solid_top10_green">
								<table class="table_col_type1">
									<caption>부산캠퍼스 Windows .NET 고급과정 교육내용</caption>
									<colgroup>
										<col style="width:30%">
										<col style="width:70%">
									</colgroup>
