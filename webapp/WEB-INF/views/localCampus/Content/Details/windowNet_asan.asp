			...
			<div id="Content" class="sub">
				...
				<section class="section mar_t40">
					<div class="section_header">
						<h4 class="fl">Windows .NET 고급과정</h4>
					...
					<div class="form_type1 bor_solid_top10_green">
						<table class="table_col_type1">
							<caption>아산캠퍼스 Windows .NET 고급과정 일정</caption>
							<colgroup>
								<col style="width:15%">
								<col style="width:35%">
								<col style="width:15%">
							...
							<tbody>
								<tr>
									...
									<td colspan="3" class="l fb">Windows .NET 고급과정</td>
								</tr>
								<tr>
									<th scope="row">강의일정</th>
									<td class="l">2015.03.02 ~ 2015.08.28 (6개월)</td>
				...
				<section class="section infoCon">
					<dl>
						<dt>교육소개</dt>
						<dd>윈도우 응용프로그램 작성에 필수 언어요소인 C/C++언어를 이해하고 다양한 자료구조 및 알고리즘 작성 능력 향상하여WinNT 기반에서 동작하는 다양한 응용 프로그램을 개발에 최적인 C#언어로 OOP와 .NET 플랫폼의 강력한 기술인 .NET 리모팅, 웹 서비스, 윈도우즈 서비스, Windows Form with C#, XML.NET, ADO.NET 등을 활용하여 다양한 형태의 응용 프로그램과 비즈니스 솔루션을 구축할 수 있는 능력을 배양함.</dd>
					</dl>
					<dl>
						<dt>교육목표</dt>
						<dd>
					...
					<dl>
						<dt>교육장소</dt>
						<dd>충남 아산시 탕정면 갈산리 100 선문대학교 원화관 5층</dd>
					</dl>
					<dl>
						<dt>교육문의</dt>
						<dd>02-3486-1422</dd>
					...
					<dl class="bg_none">
						...
						<dd>
							<div class="form_type1 bor_solid_top10_green">
								<table class="table_col_type1">
									<caption>아산캠퍼스 Windows .NET 고급과정 교육내용</caption>
									<colgroup>
										<col style="width:25%">
										<col style="width:75%">
									</colgroup>
